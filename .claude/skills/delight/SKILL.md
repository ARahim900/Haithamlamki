...
- Provide accurate, descriptive alt text that conveys the image's content and purpose (can include brand voice but must remain informative); use hidden aria-labels or sr-only spans for optional delight copy
