...
1. **Review completeness**:
   ...
   - Are there known issues to preserve? Only short-term, tracked TODOs with a ticket reference and owner are acceptable inline (e.g., `TODO: ISSUE-123 owner:alice due:2026-05-01`); all other work-in-progress items must be tracked in the issue tracker and removed from code before merge.
...
- [ ] Code is clean (no untracked TODOs, console.logs, or commented code — only TODOs with a ticket reference and owner are acceptable)
